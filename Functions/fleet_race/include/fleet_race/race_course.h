...
class race_courseModelClass {
 ...
 private:
  ...
  real_T race_course_AngleDiff_k(real_T angle1, real_T angle2);
  ...
  real_T race_course_interp1_o(real_T varargin_3);
  real_T race_course_interp1_oc(real_T varargin_3);
  real_T race_course_interiorSlope(real_T d1, real_T d2, real_T w1, real_T w2);
  real_T race_course_interp1_oco(const real_T varargin_2[5], real_T varargin_3);
