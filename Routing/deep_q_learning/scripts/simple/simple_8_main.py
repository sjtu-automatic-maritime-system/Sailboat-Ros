...
from simple_8_env import Maze
from simple_8_dqn_brain import DeepQNetwork
import numpy as np
import os
...
if __name__ == "__main__":
    # maze game
    env = Maze()
    model_path = os.path.dirname(os.path.abspath(__file__)) + "/simple_8_model20171220.ckpt"
